-- PT: Q07, leitura em pontos percentuais. Variação da taxa de inadimplência em 6 meses,
--     por modalidade, da maior deterioração para a menor.
-- EN: Q07, reading in percentage points. Six-month change in the default rate by modality.
...
select
    row_number() over (order by variacao_pp desc nulls last) as posicao,
    codigo_modalidade,
    modalidade,
