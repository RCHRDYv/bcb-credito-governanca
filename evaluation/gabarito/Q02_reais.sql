-- PT: Q02, leitura em reais. Modalidades ordenadas pelo crescimento da carteira
--     em 12 meses. A pergunta pede as cinco primeiras.
-- EN: Q02, reading in reais. Modalities ranked by 12-month portfolio growth.
...
select
    row_number() over (order by crescimento_em_reais desc nulls last) as posicao,
    codigo_modalidade,
    modalidade,
