-- PT: Q28, parte 3, leitura no mês. As três modalidades de maior aumento da
--     taxa de inadimplência, em pontos percentuais.
-- EN: Q28, part 3, reading in the month. The three modalities with the largest rise
...
comparado as (
    ...
    join por_modalidade anterior
       ...
       and anterior.data_base = last_day(ultimo.data_base - interval '1' month)
