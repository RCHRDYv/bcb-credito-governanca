-- PT: Q38, leitura na V2 (fct_carteira). Variação de cada medida no mês da mudança de
...
-- EN: Q38, reading on V2. Each measure's change in the month of the problem-
...
with mensal as (
    ...
    select
        ...
        cast(sum(carteira_inadimplencia) as double) as carteira_inadimplida,
