-- PT: Q29, leitura contra os 12 meses anteriores. Variação do último mês
--     de cada métrica nacional contra a média e o desvio padrão das 12
--     variações anteriores. Atípica quando o z passa de 2 em módulo. As
--     medidas em reais variam em percentual; as taxas, em pontos.
-- EN: Q29, reading against the previous 12 months. Latest monthly change
--     of each national metric against the mean and standard deviation of the
--     previous 12 changes; atypical when |z| > 2.
with mensal as (
...
historico as (
    ...
    from variacoes
    where recencia between 2 and 13
    group by metrica
