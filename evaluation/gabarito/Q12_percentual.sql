-- PT: Q12, leitura em percentual. Crescimento da carteira por habitante em 12 meses,
--     por UF. Cada mês usa a estimativa de população do próprio ano.
-- EN: Q12, reading in percent. 12-month growth of the portfolio per inhabitant by
...
select
    row_number() over (order by crescimento_por_habitante_pct desc) as posicao,
    uf,
