-- PT: Q24, leitura pela UF do pagador. Volume de PIX do mês dividido pela
--     carteira ativa, por UF, no último mês. PIX é fluxo e carteira é saldo.
-- EN: Q24, reading by the pagador side's state. Monthly PIX value over the
